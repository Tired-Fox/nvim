...
vim.keymap.set({ "n", "v", "i" }, "<c-k>", "<cmd>wincmd k<cr>", { silent = true })
vim.keymap.set({ "n", "v", "i" }, "<c-j>", "<cmd>wincmd j<cr>", { silent = true })
vim.keymap.set({ "n", "v", "i" }, "<c-h>", "<cmd>wincmd h<cr>", { silent = true })
vim.keymap.set({ "n", "v", "i" }, "<c-l>", "<cmd>wincmd l<cr>", { silent = true })
